...
Most of these come down to network reality or how gdc serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

gdc rate-limits like any public site. gdc already paces
...
Where a surface is gated, gdc reads a cookie or token you supply
...
`gdc`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what gdc actually did
