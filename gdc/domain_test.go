...
// HTTP behaviour is covered in gdc_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "gdc://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("gdc", "about")
	if err != nil || got.String() != "gdc://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want gdc://page/about", got.String(), err)
	}
}
